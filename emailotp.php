...
<body>
  ...
  shortname = mikrotik
        ...
        // Clear OTP from session only – keep the radcheck row intact so
        // FreeRADIUS can still verify it when MikroTik sends the RADIUS request.
        // The row is removed at the start of the next OTP request for this email.
        unset($_SESSION['otp'], $_SESSION['otp_time'], $_SESSION['otp_attempts']);

        // Prevent session fixation after successful auth
